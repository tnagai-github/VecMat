...
//
//TEST(TestVecNd, Basics002){
//  EXPECT_EQ(vecNd<4>(3.0), vecNd<4>(1.0)+ vecNd<4>(2.0)) ;
//  EXPECT_EQ(vecNd<4>(-1.0), vecNd<4>(1.0)- vecNd<4>(2.0)) ;
//  EXPECT_EQ((vecNd<2>{1,0}), (vecNd<2>{2,3} - vecNd<2>{1,3})) ;
//}
//
//TEST(TestVecNd, Basics003){
//  EXPECT_EQ(vecNd<4>(3.0), -vecNd<4>(-3.0)) ;
//  EXPECT_EQ(vecNd<4>(1.0), -1.0*vecNd<4>(-1.0)) ;
//  EXPECT_EQ((vecNd<2>{1,0}), (vecNd<2>{-1,0}*(-1.0))) ;
//}
